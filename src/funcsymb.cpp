/* funcsymb.cpp - adapted for raidtcl project 2018 - 2021 by Rainer Müller
...
QByteArray GetFuncSymb(int nr, bool active)
{
    QByteArray ba;
	...
	case 85: case 230:    //LocoFunctionIconPanto1:
                ...
                if (active) ba += "<polyline points=\"14,24 8,15 18,6 28,15 22,24\" stroke=\"black\" stroke-width=\"2\" fill=\"none\" class=\"button_on\"/>";
				else ba += "<polyline points=\"14,24 6,21 18,18 30,21 22,24\" stroke=\"black\" stroke-width=\"2\" fill=\"none\" class=\"button_off\"/>";
				return ba + "<polyline points=\"12,31 18,31 18,28 24,32 18,36 18,33 12,33 12,31\" stroke=\"black\" stroke-width=\"0\" fill=\"black\"/></svg>";
    ...
    default:    if ((nr >= 50) && (nr <= 81)) {
                    ba = "<svg width=\"36\" height=\"36\"><text x=\"4\" y=\"24\" fill=\"black\" font-size=\"20\">F";
                    return ba + QByteArray::number(nr - 50) + "</text></svg>";
                }
                else {
                    ba = "<svg width=\"36\" height=\"36\"><text x=\"8\" y=\"24\" fill=\"black\" font-size=\"12\">T";
                    return ba + QByteArray::number(nr) + "</text></svg>";
                }
	}
}
...
QPixmap getFunctionPixmap(int type, bool active)
{
    ...
    pixmap.loadFromData(GetFuncSymb(type, active));
    return pixmap;
}
